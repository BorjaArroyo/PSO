...
\providecommand{\algDtables}{\StrLeft{PSO 4}{\ntables}}
\providecommand{\algCtables}{\StrLeft{PSO 3}{\ntables}}
\providecommand{\algBtables}{\StrLeft{PSO 2}{\ntables}}
\providecommand{\algAtables}{\StrLeft{PSO 1}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{PSO_1_PSO_2_PSO_3_PSO_4/}
\providecommand{\algorithmA}{PSO 1}
\providecommand{\algorithmB}{PSO 2}
\providecommand{\algorithmC}{PSO 3}
\providecommand{\algorithmD}{PSO 4}
\providecommand{\bbobecdfcaptionsinglefunctionssingledim}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of objective function evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v0.0.0}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{PSO 4{}}
\providecommand{\algfolder}{PSO_4/}
...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v0.0.0}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{PSO 3{}}
\providecommand{\algfolder}{PSO_3/}
\providecommand{\bbobecdfcaptionallgroups}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of objective function evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
