...
\newcommand{\algorithmA}{PSO_1}  % first argument in the post-processing
\newcommand{\algorithmB}{PSO_2}  % second argument in the post-processing
\newcommand{\algorithmC}{PSO_3}  % third argument in the post-processing
\newcommand{\algorithmD}{PSO_4}  % fourth argument in the post-processing
% for the short acronyms in the tables, adjust the following to lines if required.
\newcommand{\algorithmAshort}{PSO_1}  % first argument in the post-processing
\newcommand{\algorithmBshort}{PSO_2}  % second argument in the post-processing
\newcommand{\algorithmCshort}{PSO_3}  % third argument in the post-processing
\newcommand{\algorithmDshort}{PSO_4}  % fourth argument in the post-processing
...
2.3.1, the plots were produced with version 2.3.1.
...
\bibliography{bbob.bib}  % bbob.bib is the name of the Bibliography in this case
