...
\providecommand{\algBtables}{\StrLeft{PSO2}{\ntables}}
\providecommand{\algAtables}{\StrLeft{PSO1}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
...
\providecommand{\algsfolder}{PSO1_PSO2/}
\providecommand{\algorithmA}{PSO1}
\providecommand{\algorithmB}{PSO2}
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v0.0.0}
\providecommand{\numofalgs}{0}
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v0.0.0}
\providecommand{\numofalgs}{0}
